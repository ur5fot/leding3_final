...
<header>
    <div class="topLine">
        <div class="container">
            <ul class="menu_main">
                <li class="user"><?php echo get_post_meta('37', "name", true); ?></li>
                <li>
                    <div class="userTel"><i class="tel"></i>
                        <a href="tel:<?php echo get_post_meta('37', " tel ", true); ?>">
                            <?php echo get_post_meta('37', "tel", true); ?></a>
                    </div>
                    <div class="userEmail">
                        <i class="email"></i>
...
<main>
    ...
    <article class="foto">
        <div class="container">
            ...
            <div class="Collage">
                <img src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/galliri1.png" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/UKRt3jS_R0I-olivia.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/galliri1.png" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt=""><img
                    ...
                    src="<?php bloginfo('template_directory'); ?>/img/foto/galliri1.png" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/UKRt3jS_R0I-olivia.jpg" alt=""><img
                    src="<?php bloginfo('template_directory'); ?>/img/foto/31736756-001.jpg" alt="">
            </div>
...
<script type="text/javascript" src="lib/mosaicflow/jquery.mosaicflow.min.js"></script>
...
<script type="text/javascript"
        src="<?php bloginfo('template_directory'); ?>/lib/collagePlus/jquery.collagePlus.min.js"></script>
